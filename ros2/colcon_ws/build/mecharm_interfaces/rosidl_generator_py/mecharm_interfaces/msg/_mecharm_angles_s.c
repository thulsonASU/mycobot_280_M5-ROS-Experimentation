...
bool mecharm_interfaces__msg__mecharm_angles__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mecharm_interfaces.msg._mecharm_angles.MecharmAngles", full_classname_dest, 52) == 0);
  }
  mecharm_interfaces__msg__MecharmAngles * ros_message = _ros_message;
  {  // joint_1
...
{
  /* NOTE(esteve): Call constructor of MecharmAngles */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mecharm_interfaces.msg._mecharm_angles");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MecharmAngles");
