...
bool mypalletizer_interfaces__msg__mypal_angles__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mypalletizer_interfaces.msg._mypal_angles.MypalAngles", full_classname_dest, 53) == 0);
  }
  mypalletizer_interfaces__msg__MypalAngles * ros_message = _ros_message;
  {  // joint_1
...
{
  /* NOTE(esteve): Call constructor of MypalAngles */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mypalletizer_interfaces.msg._mypal_angles");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MypalAngles");
