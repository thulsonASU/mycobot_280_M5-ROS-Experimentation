...
bool mecharm_interfaces__msg__mecharm_coords__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mecharm_interfaces.msg._mecharm_coords.MecharmCoords", full_classname_dest, 52) == 0);
  }
  mecharm_interfaces__msg__MecharmCoords * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of MecharmCoords */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mecharm_interfaces.msg._mecharm_coords");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MecharmCoords");
