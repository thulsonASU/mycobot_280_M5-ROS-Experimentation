...
bool mecharm_interfaces__msg__mecharm_set_coords__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mecharm_interfaces.msg._mecharm_set_coords.MecharmSetCoords", full_classname_dest, 59) == 0);
  }
  mecharm_interfaces__msg__MecharmSetCoords * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of MecharmSetCoords */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mecharm_interfaces.msg._mecharm_set_coords");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MecharmSetCoords");
