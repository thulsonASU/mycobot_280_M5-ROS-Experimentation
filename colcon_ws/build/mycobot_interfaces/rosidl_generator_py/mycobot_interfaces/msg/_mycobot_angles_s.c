...
bool mycobot_interfaces__msg__mycobot_angles__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mycobot_interfaces.msg._mycobot_angles.MycobotAngles", full_classname_dest, 52) == 0);
  }
  mycobot_interfaces__msg__MycobotAngles * ros_message = _ros_message;
  {  // joint_1
...
PyObject * mycobot_interfaces__msg__mycobot_angles__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mycobot_interfaces.msg._mycobot_angles");
